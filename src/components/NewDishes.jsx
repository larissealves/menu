...
export default function AddDishes() {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const res = await fetch('/api/get/categoryList')
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch('/api/new/addDishes', {
            method: 'POST',
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <textarea
                            ...
                            required
                        />
                        <select name='categoryID' valu={formDishes.categoryId} onChange={handleChange} require>
